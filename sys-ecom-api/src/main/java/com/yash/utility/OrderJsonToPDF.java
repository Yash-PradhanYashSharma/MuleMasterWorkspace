...
public class OrderJsonToPDF {
	...
	public byte[] jsontopdf(String filename, String content, String varr) throws IOException {
...

		{
			...
			String orderId = "";
			String path = "D:/studio-workspace/sample/src/main/resources/images/yashlogo.png";
